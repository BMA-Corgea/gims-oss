...
# ------- NEW: Pre-phrase UI schema (only used when TOOL_KIND == "pphrase") -------
# The core/GUI can read this to render a small settings UI before running.
# Kinds supported: "bool" | "single" | "multi" | "text" | "number"
# Options can be explicit (list of {label,value}) OR a reference like {"source": "noun: Sample"}.
PREPHRASE_SETTINGS: List[Dict[str, Any]] = [
    ...
    #   "label": "Samples",
    #   "kind": "multi",
    #   "options": {"source": "noun: Sample"},   # the core will resolve to [{label, value}, ...]
