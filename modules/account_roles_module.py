# modules/account_roles_module.py
...
from nodes.pages.account_roles_node import account_roles_node
MODULE_NAME        = "Account Roles"
DESCRIPTION        = "UI node that serves gui/components/account_roles.html"
VERSION            = "0.1.0"
ROUTE_PATH         = "/account_roles"
INJECT_SCRIPTS     = ["/orchestrate/inject.js"]
INJECT_STYLESHEETS = []
# ──────────────────────────────────────────────────────────────────────────────

account_roles_module = Module(
    name=MODULE_NAME,
    nodes=[
        account_roles_node,
        login_node,
