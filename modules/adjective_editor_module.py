...
from nodes.pages.adjective_editor_node import adjective_editor_node
MODULE_NAME        = "Adjective Editor"
DESCRIPTION        = "UI node that serves gui/components/adjective_editor.html"
VERSION            = "0.1.0"
ROUTE_PATH         = "/adjective_editor"
INJECT_SCRIPTS     = ["/orchestrate/inject.js"]
INJECT_STYLESHEETS = []
# ──────────────────────────────────────────────────────────────────────────────

adjective_editor_module = Module(
    name=MODULE_NAME,
    nodes=[
        adjective_editor_node,
        login_node,
