...
from nodes.pages.prepositional_phrase_node import prepositional_phrase_node
MODULE_NAME        = "Image Capture"
DESCRIPTION        = "UI node that serves gui/components/prepositional_phrase_runner.html"
VERSION            = "0.1.0"
ROUTE_PATH         = "/prepositional_phrase_runner"
INJECT_SCRIPTS     = ["/orchestrate/inject.js"]
INJECT_STYLESHEETS = []
# ──────────────────────────────────────────────────────────────────────────────

prepositional_phrase_module = Module(
    name=MODULE_NAME,
    nodes=[
        prepositional_phrase_node,
        login_node,
