...
NODE_NAME    = "Custom Upload"
ROUTE_PATH   = "/custom_upload"           # URL endpoint
HTML_FILE    = "custom_upload.html"       # in gui/components/
ICON         = "📝"                       # launcher icon
LABEL        = "Custom Upload"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
