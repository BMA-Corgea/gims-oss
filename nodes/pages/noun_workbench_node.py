...
NODE_NAME    = "Noun Workbench"
ROUTE_PATH   = "/noun_workbench"           # URL endpoint
HTML_FILE    = "noun_workbench.html"       # in gui/components/
ICON         = "📇"                       # launcher icon
LABEL        = "Noun Workbench"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
