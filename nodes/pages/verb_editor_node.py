...
NODE_NAME    = "Verb Editor"
ROUTE_PATH   = "/verb_editor"           # URL endpoint
HTML_FILE    = "verb_editor.html"       # in gui/components/
ICON         = "⚡"                       # launcher icon
LABEL        = "Verb Editor"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
