...
NODE_NAME    = "Adverb Editor"
ROUTE_PATH   = "/adverb_editor"           # URL endpoint
HTML_FILE    = "adverb.html"       # in gui/components/
ICON         = "🎯"                       # launcher icon
LABEL        = "Adverb Editor"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
