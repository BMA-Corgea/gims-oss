...
NODE_NAME    = "Adjective Editor"
ROUTE_PATH   = "/adjective_editor"           # URL endpoint
HTML_FILE    = "adjective_editor.html"       # in gui/components/
ICON         = "🏷️"                       # launcher icon
LABEL        = "Adjective Editor"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
