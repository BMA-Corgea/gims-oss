...
NODE_NAME    = "Prepositional Phrase Runner"
ROUTE_PATH   = "/prepositional_phrase_runner"           # URL endpoint
HTML_FILE    = "prepositional_phrase_runner.html"       # in gui/components/
ICON         = "📜"                       # launcher icon
LABEL        = "Prepositional Phrase Runner"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
...
prepositional_phrase_node = Node(
    name=NODE_NAME,
    kind=NodeKind.UI,
    router=router,
