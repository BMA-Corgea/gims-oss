...
NODE_NAME    = "Verb Workbench"
ROUTE_PATH   = "/verb_workbench"           # URL endpoint
HTML_FILE    = "verb_workbench.html"       # in gui/components/
ICON         = "✨"                       # launcher icon
LABEL        = "Verb Workbench"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
