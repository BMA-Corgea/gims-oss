...
NODE_NAME    = "Noun Configure"
ROUTE_PATH   = "/noun_configure"           # URL endpoint
HTML_FILE    = "noun_configure.html"       # in gui/components/
ICON         = "📦"                       # launcher icon
LABEL        = "Noun Configure"            # launcher label
# ──────────────────────────────────────────────────────────────────────────────
